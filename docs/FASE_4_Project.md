...
> **Nota:** questo file resta uno **snapshot** al completamento della **FASE 4**. Le modifiche alla sezione About nella **FASE 8** (**F8.D**) sono descritte in [`FASE_8_Riordino_Contenuti.md`](FASE_8_Riordino_Contenuti.md) e **non** vengono replicate qui. Tipografia (lead About, token condivisi): [`SPECIFICHE_SITO.md`](SPECIFICHE_SITO.md) § 1.6 e **F8.G** in FASE 8.
